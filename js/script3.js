...
$(window).on('load', function () {
  ...
  $preload = $('#preloader');
    ...
    $preload.delay(300).fadeOut('350', function() {
  wow.init();
...
var contactsButton = $('.header--mob__contacts-button');
var wrap=$('#wrap');
...
function openMobileMenu() {
  ...
  $('.header--mob__logo, .header--mob__contacts-button').addClass('hidden');
  $('.hamburger-button').addClass('open');
  $('.header--mob__menu-button').addClass('open');
  $('.main-page').wrap('<div id="wrap"></div>');
toolTimeline.to('.header--mob__menu', 0.2, {left:'0',ease:Linear.easeInOut} );
...
closeMobileMenu();
  ...
  $('.header--mob__contacts-button').addClass('open');
