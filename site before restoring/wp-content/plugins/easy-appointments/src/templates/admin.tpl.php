			...
			<tr>
				...
				<td>
					<input class="field" data-key="trans.service" name="service" type="text"
						   value="<%= _.findWhere(settings, {ea_key:'trans.service'}).ea_value %>"><br>
				</td>
			</tr>
			<tr>
				<th class="row">
				...
				<td>
					<input class="field" data-key="trans.location" name="location" type="text"
						   value="<%= _.findWhere(settings, {ea_key:'trans.location'}).ea_value %>"><br>
				</td>
			</tr>
			<tr>
				<th class="row">
				...
				<td>
					<input class="field" data-key="trans.worker" name="worker" type="text"
						   value="<%= _.findWhere(settings, {ea_key:'trans.worker'}).ea_value %>"><br>
				</td>
			</tr>
			<tr>
				<th class="row">
				...
				<td>
					<input class="field" data-key="trans.done_message" name="done_message" type="text"
						   value="<%= _.findWhere(settings, {ea_key:'trans.done_message'}).ea_value %>"><br>
				</td>
				<td>
