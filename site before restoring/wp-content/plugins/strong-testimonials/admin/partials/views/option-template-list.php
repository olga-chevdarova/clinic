...
<td>
	<div class="radio-wrap">
		<div class="table-row">
			...
			<div class="radio-buttons table-cell">
				<ul class="radio-list">
					...
					if ( ! $template_found ) {
						...
						echo '<li>';
						echo '<input type="radio" id="' . $t2 . '" class="error" name="view[data][template]" value="' . $t . '" checked>';
						echo '<label for="' . $t2 . '">';
                    ...
                    // Pseudo optgroups
					$current_source = '';
					foreach ( $templates as $source => $source_templates ) {
                        ...
                        foreach ( $source_templates as $key => $template ) {
                            ...
                            echo '<li>';
                            echo '<input type="radio" id="' . $key2 . '" name="view[data][template]" value="' . $key . '"' . checked( $key, $view['template'], false ) . '>';
                            echo '<label for="' . $key2 . '">';
                            echo $template['name'];
                            echo '</label>';
                            echo '</li>';
			...
			<!-- Template Info -->
			<div id="view-template-info" class="radio-description table-cell">
				<?php
				if ( ! $template_found ) {
