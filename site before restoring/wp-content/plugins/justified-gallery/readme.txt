...
Tags: best gallery plugin, wordpress gallery, justified gallery, gallery grid, free photo gallery
...
= Demo =
See how it works on the [DEMO](http://damiangora.com/justified-gallery) site.
...
= How to use? =
1. Create galleries as before. Read more about [The WordPress Gallery](https://codex.wordpress.org/The_WordPress_Gallery)
2. To set your preferences go to Settings -> Justified Gallery.

= Feedback =

Any suggestions or comments are welcome. Feel free to contact me using this [contact form](http://damiangora.com/justified-gallery/#contact).
...
* NEW: Compatibility with the Enhanced Media Library
* NEW: Allows to use links in a media description
* FIX: PHP Warnings caused by using the 'post_gallery' filter by other plugins without a third parameter: $instance
* FIX: Trivial CSS

= 1.0.0, June 25, 2016 =
* NEW: Loupe icon if there is no caption
