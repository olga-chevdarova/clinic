	...
	public function hide_gallery_setting() {
		...
		<style>
			.gallery-settings h2::after{
				...
				margin-top: 15px;
                text-transform: none;
				content: "<?php _e( 'You use the Justified Gallery plugin. The options (Columns) and (Size) will be ignored. The option (Link to) can also be overridden by your lightbox settings.', DGWT_JG_DOMAIN ) ?>";
			}
